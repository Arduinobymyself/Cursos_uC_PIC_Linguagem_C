...
; Conteúdo: Aula023 - ANTI-BOUNCING PARA BOTÕES
;
;
...
inicio:
	...
	movwf 	OPTION_REG					;habilita resistores de pull-up interno
...
loop:									;loop infinito
	;SEU CÓDIGO AQUI
	movlw 	v_bouncing					;W = v_bouncing
	movwf 	bouncing					;carrega no registrador bouncing
	
testa_botao
	btfsc 	S1							;botão pressionado?
	goto 	loop						;não, volta a testar o botão
	decfsz 	bouncing,F					;sim, decrementa bouncing, chegou em zero?
	goto 	testa_botao					;não, volta a testar o botão
	
	comf 	PORTA						;sim, inverte o PORT A (invertendo o estado dos LEDs)
