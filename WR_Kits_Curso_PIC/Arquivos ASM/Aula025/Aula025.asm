...
; Conteúdo: Aula025 - MULTIPLICAÇÃO C = A * B
;
;
...
;+++++ registradores de uso geral GFRs +++++
	cblock		H'20'
				A0						;conteúdo do primeiro operando
				B0						;conteúdo do segundo operando
...
loop:									;loop infinito
	...
	goto 		loop					;também pode ser usado goto $ como loop infinito
			
;+++++ desenvolvimento das sub-rotinas +++++
multiplica:
	clrf		C0						;limpa conteúdo do registrador LSB de resultado
	clrf		C1						;limpa conteúdo do registrador MSB de resultado
	movf		A0, W					;W = A0
	movwf		C0						;C0 = W
...
loop_multiplica:
	...
	goto		loop_multiplica			;continua a multiplicação	
